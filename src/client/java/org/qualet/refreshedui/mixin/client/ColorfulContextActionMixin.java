 ...
 * muted darker fill, see {@link RoundedAreas#renderSelectionFrame}), matching the refreshed look. The stroke
 * keeps the action's OWN tint {@code color} (custom per action), so colorful actions stay their colour.</p>
 */
...
public abstract class ColorfulContextActionMixin
{
    ...
    {
        RoundedAreas.renderSelectionFrame(context.batcher, x, y, w, h, this.color, UICornerRadii.buttonsAndTrackpads());
    }
}
